      ...
      html: `
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          <div class="ds-statcard">
            ...
            <span class="ds-statcard__value" style="color:var(--status-error-default)">-0.48%</span>
          ...
          <div class="ds-statcard">
            ...
            <span class="ds-statcard__value" style="color:var(--status-success-default)">+0.08%</span>
            <span class="ds-statcard__delta is-down">
              <i data-lucide="arrow-down" class="w-3 h-3"></i>
              <span>-2.71pp</span>
              <span class="ds-statcard__caption">vs 前日</span>
          ...
          <div class="ds-statcard">
            ...
            <span class="ds-statcard__value" style="color:var(--status-success-default)">+0.56%</span>
            <span class="ds-statcard__delta is-down">
              <i data-lucide="arrow-down" class="w-3 h-3"></i>
              <span>-0.89pp</span>
              <span class="ds-statcard__caption">vs 前日</span>
        ...
        <div class="ds-card">
          ...
          <p class="text-[var(--text-secondary)] text-sm leading-relaxed">
            您今日持仓收益 <span class="num" style="color:var(--status-success-default)">+0.08%</span>，跑赢全市场中位数 <span class="num" style="color:var(--status-error-default)">-0.48%</span> 共 <strong>0.56个百分点</strong>，连续三日实现正超额收益。在多数个股下跌、中证1000跌近1%的背景下，持仓仍能维持正收益，说明持仓结构偏向了今日相对强势的科创/成长方向。持仓防御能力持续体现。
          </p>
        </div>
        ...
        <div class="ds-alert ds-alert--warning">
          ...
          <div>
            ...
            <div class="ds-alert__desc">今日中位数 <span class="num" style="color:var(--status-error-default)">-0.48%</span>，全市场多数个股下跌，赚钱效应较昨日的强普涨（<span class="num" style="color:var(--status-success-default)">+1.34%</span>）明显转弱。沪深300数据待核实。您的持仓收益 <span class="num" style="color:var(--status-success-default)">+0.08%</span>，跑赢中位数 <strong>0.56个百分点</strong>，超额收益连续三日为正。</div>
          </div>
        </div>
      `
    },
    {
      ...
      html: `
          ...
          <table class="ds-table min-w-[680px]">
            ...
            <tbody>
              <tr>
                ...
                <td>科创50</td>
                <td class="num" style="color:var(--status-success-default)">+0.70%</td>
                <td class="num" style="color:var(--status-success-default)">+3.04%</td>
                <td class="num" style="color:var(--status-error-default)">-2.34pp</td>
                <td class="num">1,718亿</td>
              </tr>
              <tr>
                <td><span class="ds-tag ds-tag--success">最强</span></td>
                <td>创业板指</td>
                <td class="num" style="color:var(--status-success-default)">+0.02%</td>
                <td class="num" style="color:var(--status-success-default)">+2.80%</td>
                <td class="num" style="color:var(--status-error-default)">-2.78pp</td>
                <td class="num">5,580亿</td>
              </tr>
              <tr>
                <td><span class="ds-tag ds-tag--success">最强</span></td>
                <td>深证成指</td>
                <td class="num" style="color:var(--status-error-default)">-0.20%</td>
                <td class="num" style="color:var(--status-success-default)">+2.19%</td>
                <td class="num" style="color:var(--status-error-default)">-2.39pp</td>
                <td class="num">9,831亿</td>
              </tr>
              <tr>
                <td><span class="ds-tag ds-tag--danger">最弱</span></td>
                <td>中证1000</td>
                <td class="num" style="color:var(--status-error-default)">-0.85%</td>
                <td class="num" style="color:var(--status-success-default)">+1.52%</td>
                <td class="num" style="color:var(--status-error-default)">-2.37pp</td>
                <td class="num">4,820亿</td>
              </tr>
              <tr>
                <td><span class="ds-tag ds-tag--danger">最弱</span></td>
                <td>中证500</td>
                <td class="num" style="color:var(--status-error-default)">-0.63%</td>
                <td class="num" style="color:var(--status-success-default)">+1.61%</td>
                <td class="num" style="color:var(--status-error-default)">-2.24pp</td>
                <td class="num">4,245亿</td>
              </tr>
              <tr>
                <td><span class="ds-tag ds-tag--danger">最弱</span></td>
                <td>上证指数</td>
                <td class="num" style="color:var(--status-error-default)">-0.19%</td>
                <td class="num" style="color:var(--status-success-default)">+1.24%</td>
                <td class="num" style="color:var(--status-error-default)">-1.43pp</td>
        ...
        <div class="ds-card">
          ...
          <div class="overflow-x-auto -mx-6 px-6">
            <table class="ds-table min-w-[560px]">
              ...
              <tbody>
                <tr><td>上证指数</td><td class="num" style="color:var(--status-error-default)">-0.19%</td><td class="num">3,968.05</td><td class="num">9,039亿</td></tr>
                <tr><td>深证成指</td><td class="num" style="color:var(--status-error-default)">-0.20%</td><td class="num">14,640.32</td><td class="num">9,831亿</td></tr>
                <tr><td>创业板指</td><td class="num" style="color:var(--status-success-default)">+0.02%</td><td class="num">3,728.50</td><td class="num">5,580亿</td></tr>
                <tr><td>科创50</td><td class="num" style="color:var(--status-success-default)">+0.70%</td><td class="num">1,781.96</td><td class="num">1,718亿</td></tr>
                <tr><td>中证500</td><td class="num" style="color:var(--status-error-default)">-0.63%</td><td class="num">8,068.14</td><td class="num">4,245亿</td></tr>
                <tr><td>中证1000</td><td class="num" style="color:var(--status-error-default)">-0.85%</td><td class="num">7,820.82</td><td class="num">4,820亿</td></tr>
        ...
        <div class="ds-card">
          ...
          <p class="text-[var(--text-secondary)] text-sm leading-relaxed">
            <strong class="text-[var(--text-default)]">科创50</strong>（<span class="num" style="color:var(--status-success-default)">+0.70%</span>）逆势领涨，延续昨日暴涨3%的强势；<strong class="text-[var(--text-default)]">创业板指</strong>微涨 <span class="num" style="color:var(--status-success-default)">+0.02%</span> 勉强收红。<strong class="text-[var(--text-default)]">中证1000</strong>（<span class="num" style="color:var(--status-error-default)">-0.85%</span>）和<strong class="text-[var(--text-default)]">中证500</strong>（<span class="num" style="color:var(--status-error-default)">-0.63%</span>）跌幅居前，中小盘股整体承压明显。市场呈现“成长抗跌、小盘领跌”格局，属昨日大涨后的正常分化整理。
          </p>
        </div>
      `
    },
          ...
          <div class="ds-stack-16">
            ...
            <ul class="ds-stack-12 text-sm text-[var(--text-secondary)] leading-relaxed">
              <li class="flex gap-3">
                ...
                <span><strong class="text-[var(--text-default)]">科创50逆势独涨：</strong>科创50（<span class="num" style="color:var(--status-success-default)">+0.70%</span>）成为今日唯一显著上涨的主要指数，延续昨日暴涨3%的强势。两日累计涨幅超 <strong>3.7%</strong>，短期获利回吐压力需关注。</span>
              </li>
              <li class="flex gap-3">
                <i data-lucide="trending-up" class="w-4 h-4 flex-shrink-0 mt-0.5" style="color:var(--status-success-default)"></i>
                <span><strong class="text-[var(--text-default)]">创业板微幅收红：</strong>创业板指微涨 <span class="num" style="color:var(--status-success-default)">+0.02%</span>，勉强收红，较昨日 <strong>+2.80%</strong> 大幅回落。</span>
              </li>
              <li class="flex gap-3">
                <i data-lucide="trending-down" class="w-4 h-4 flex-shrink-0 mt-0.5" style="color:var(--status-error-default)"></i>
                <span><strong class="text-[var(--text-default)]">中小盘明显承压：</strong>中证1000（<span class="num" style="color:var(--status-error-default)">-0.85%</span>）和中证500（<span class="num" style="color:var(--status-error-default)">-0.63%</span>）跌幅居前，中小盘股整体表现弱于大盘。</span>
              </li>
              <li class="flex gap-3">
                <i data-lucide="trending-down" class="w-4 h-4 flex-shrink-0 mt-0.5" style="color:var(--status-error-default)"></i>
                <span><strong class="text-[var(--text-default)]">主板小幅回调：</strong>上证指数跌 <span class="num" style="color:var(--status-error-default)">-0.19%</span>，深证成指跌 <span class="num" style="color:var(--status-error-default)">-0.20%</span>，属昨日大涨后的正常整理。</span>
              </li>
              <li class="flex gap-3">
                <i data-lucide="pie-chart" class="w-4 h-4 flex-shrink-0 mt-0.5" style="color:var(--accent-violet)"></i>
                <span><strong class="text-[var(--text-default)]">持仓表现稳健：</strong>您今日持仓收益 <span class="num" style="color:var(--status-success-default)">+0.08%</span>，跑赢全市场中位数 <span class="num" style="color:var(--status-error-default)">-0.48%</span> 共 <strong>0.56个百分点</strong>，连续三日实现正超额。在多数个股下跌的背景下，持仓仍能维持正收益，说明持仓结构偏向了今日相对强势的科创/成长方向。</span>
              </li>
              <li class="flex gap-3">
