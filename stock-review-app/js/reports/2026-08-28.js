        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          ...
          <div class="ds-statcard">
            ...
            <span class="ds-statcard__delta">
              <span class="ds-tag ds-tag--warning">分化加剧</span>
              <span class="ds-statcard__caption">赚钱效应显著转弱</span>
            </span>
          </div>
        </div>
