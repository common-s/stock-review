      ...
      html: `
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          <div class="ds-statcard">
            ...
            <span class="ds-statcard__value" style="color:var(--stock-down)">-0.13%</span>
          ...
          <div class="ds-statcard">
            ...
            <span class="ds-statcard__value" style="color:var(--stock-down)">-0.30%</span>
            <span class="ds-statcard__delta is-down">
              <i data-lucide="arrow-down" class="w-3 h-3"></i>
              <span>-0.35pp</span>
              <span class="ds-statcard__caption">较前日</span>
          ...
          <div class="ds-statcard">
            ...
            <span class="ds-statcard__value" style="color:var(--stock-up)">+0.57%</span>
          ...
          <div class="ds-statcard">
            ...
            <span class="ds-statcard__value" style="color:var(--stock-down)">-0.70%</span>
            <span class="ds-statcard__delta is-down">
              <i data-lucide="arrow-down" class="w-3 h-3"></i>
              <span>-0.78pp</span>
              <span class="ds-statcard__caption">较前日</span>
          ...
          <div class="ds-statcard">
            ...
            <span class="ds-statcard__value" style="color:var(--stock-down)">-0.17%</span>
            <span class="ds-statcard__delta is-down">
              <i data-lucide="arrow-down" class="w-3 h-3"></i>
              <span>-0.05pp</span>
              <span class="ds-statcard__caption">较前日</span>
          ...
          <table class="ds-table min-w-[680px]">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="num" style="color:var(--stock-down)">-0.05pp</td>
              </tr>
              <tr>
                <td>赚钱效应评级</td>
                <td>指数强于个股（2505涨/2862跌，赚钱效应46.67%）</td>
                <td>弱普涨</td>
                <td style="color:var(--stock-down)">赚钱效应转弱</td>
              </tr>
            </tbody>
          </table>
        </div>
        ...
        <div class="ds-card">
          <p class="text-[var(--text-secondary)] text-sm leading-relaxed">
            今日中位数<span class="num" style="color:var(--stock-down)">-0.13%</span>，但沪深300大涨<span class="num" style="color:var(--stock-up)">0.57%</span>，剪刀差扩大至<span class="num" style="color:var(--stock-down)">-0.70%</span>，说明权重股显著跑赢中小盘，属典型的"赚指数不赚钱"行情。您的持仓收益<span class="num" style="color:var(--stock-down)">-0.30%</span>，跑输全市场中位数0.17个百分点，连续两日跑输市场平均，超额收益持续为负，需重点关注持仓结构是否偏向了今日表现弱势的中小盘/题材方向。
          </p>
        </div>
      `
    },
    { id: "profit", index: "02", title: "赚钱效应分析", html: `<div class="ds-profit__stack"><div class="ds-profit-rating"><div class="ds-profit-rating__icon-wrap">⚠️</div><div class="ds-profit-rating__body"><div class="ds-profit-rating__title">指数强于个股</div><div class="ds-profit-rating__chips"><span class="ds-tag ds-tag--warning">指数强于个股</span><span class="ds-tag ds-tag--warning">💡 指数强 · 剪刀差 -0.70%</span></div><p class="ds-profit-rating__desc">全市场 <b>2,505</b> 只个股上涨 · <b>2,862</b> 只下跌 · 上涨占比约 <b>46.7%</b> · <span style="color:var(--stock-down)">失真：权重跑赢个股 -0.70%，赚指数不赚钱</span></p></div><div class="ds-profit-rating__figure"><div class="ds-profit-rating__figure-num" style="color:var(--stock-up)">46.7%</div><div class="ds-profit-rating__figure-label">上涨占比</div></div></div><div class="ds-card"><h3 class="ds-card__title">个股涨跌热力指标</h3><div class="ds-profit-heatgrid"><div class="ds-heat-cell is-up"><div class="ds-heat-cell__head"><i data-lucide="trending-up"></i>上涨个股数</div><div class="ds-heat-cell__val">2,505</div></div><div class="ds-heat-cell is-down"><div class="ds-heat-cell__head"><i data-lucide="trending-down"></i>下跌个股数</div><div class="ds-heat-cell__val">2,862</div></div><div class="ds-heat-cell is-up"><div class="ds-heat-cell__head"><i data-lucide="flame"></i>涨停家数</div><div class="ds-heat-cell__val">—</div></div><div class="ds-heat-cell is-down"><div class="ds-heat-cell__head"><i data-lucide="snowflake"></i>跌停家数</div><div class="ds-heat-cell__val">—</div></div><div class="ds-heat-cell is-down"><div class="ds-heat-cell__head"><i data-lucide="pie-chart"></i>上涨占比</div><div class="ds-heat-cell__val">46.7%</div></div><div class="ds-heat-cell is-down"><div class="ds-heat-cell__head"><i data-lucide="gauge"></i>个股中位数</div><div class="ds-heat-cell__val">-0.13%</div><div class="ds-heat-cell__sub">全市场个股涨跌幅中位数</div></div></div></div><div class="ds-card"><h3 class="ds-card__title">个股 vs 权重（失真度对比）</h3><div class="ds-profit-distortion"><div class="ds-profit-distortion__col"><div class="ds-profit-distortion__vs">个 股</div><div class="ds-statcard"><span class="ds-statcard__label">个股涨跌幅中位数</span><span class="ds-statcard__value" style="color:var(--stock-down)">-0.13%</span></div></div><div class="ds-profit-distortion__scissor"><div class="lbl">指数失真剪刀差</div><div class="big" style="color:var(--stock-down)">-0.70%</div><span class="ds-tag ds-tag--warning">指数强</span><div class="lbl" style="margin-top:8px;letter-spacing:0.02em;text-transform:none">权重跑赢个股 -0.70%，赚指数不赚钱</div></div><div class="ds-profit-distortion__col"><div class="ds-profit-distortion__vs">权 重</div><div class="ds-statcard"><span class="ds-statcard__label">沪深300 加权指数</span><span class="ds-statcard__value" style="color:var(--stock-up)">+0.57%</span></div></div></div></div><div class="ds-card"><h3 class="ds-card__title">持仓 vs 市场（超额收益对比）</h3><div class="ds-profit-holding"><div class="ds-profit-distortion__col"><div class="ds-profit-distortion__vs">持 仓</div><div class="ds-statcard"><span class="ds-statcard__label">持仓收益率</span><span class="ds-statcard__value" style="color:var(--stock-down)">-0.30%</span></div></div><div class="ds-profit-holding__excess"><div class="lbl">超 额 收 益</div><div class="num" style="color:var(--status-warning-default)">-0.17%</div><span class="ds-tag ds-tag--warning">持平市场</span><div class="ds-heat-cell__sub" style="text-align:center">基本持平市场（超额收益接近 0）</div></div><div class="ds-profit-distortion__col"><div class="ds-profit-distortion__vs">市 场</div><div class="ds-statcard"><span class="ds-statcard__label">全市场中位数</span><span class="ds-statcard__value" style="color:var(--stock-down)">-0.13%</span></div></div></div><div class="ds-profit-holding__advice is-flat">💡 超额收益基本持平市场平均，建议关注后续持仓与市场风格的匹配度。</div></div></div>` },
    {
      id: "style",
      index: "03",
      title: "风格强弱排名",
      html: `
          ...
          <table class="ds-table min-w-[720px]">
            ...
            <tbody>
              <tr>
                ...
                <td class="num" style="color:var(--stock-up)">+0.79pp</td>
              ...
              <tr>
                <td><span class="ds-tag ds-tag--success">最强</span></td>
                <td>深证成指</td>
                <td class="num" style="color:var(--stock-up)">+0.87%</td>
                <td class="num" style="color:var(--stock-up)">+0.59%</td>
                <td class="num" style="color:var(--stock-up)">+0.28pp</td>
              ...
              <tr>
                ...
                <td class="num" style="color:var(--stock-down)">-0.51pp</td>
              ...
              <tr>
                <td><span class="ds-tag ds-tag--danger">最弱</span></td>
                <td>科创50</td>
                <td class="num" style="color:var(--stock-up)">+0.04%</td>
                <td class="num" style="color:var(--stock-down)">-0.87%</td>
                <td class="num" style="color:var(--stock-up)">+0.91pp</td>
        ...
        <div class="ds-card">
          ...
          <div class="overflow-x-auto -mx-6 px-6">
            <table class="ds-table min-w-[560px]">
              ...
              <tbody>
                <tr><td>上证指数</td><td class="num" style="color:var(--stock-up)">+0.04%</td><td class="num">3,905.20</td><td class="num">8,834.2亿</td></tr>
                <tr><td>深证成指</td><td class="num" style="color:var(--stock-up)">+0.87%</td><td class="num">14,094.17</td><td class="num">9,958.4亿</td></tr>
                <tr><td>沪深300</td><td class="num" style="color:var(--stock-up)">+0.57%</td><td class="num">4,618.90</td><td class="num">—</td></tr>
                <tr><td>科创50</td><td class="num" style="color:var(--stock-up)">+0.04%</td><td class="num">1,653.56</td><td class="num">—</td></tr>
                <tr><td>创业板指</td><td class="num" style="color:var(--stock-up)">+1.43%</td><td class="num">3,545.58</td><td class="num">4,914.5亿</td></tr>
                <tr><td>中证500</td><td class="num" style="color:var(--stock-up)">+0.05%</td><td class="num">7,854.33</td><td class="num">—</td></tr>
                <tr><td>中证1000</td><td class="num">待核实</td><td class="num">—</td><td class="num">—</td></tr>
                <tr><td>北证50</td><td class="num" style="color:var(--stock-down)">-0.57%</td><td class="num">1,075.38</td><td class="num">131亿</td></tr>
                <tr><td>中证2000</td><td class="num" style="color:var(--stock-up)">+1.56%</td><td class="num">3,084.59</td><td class="num">—</td></tr>
                <tr><td>恒生指数</td><td class="num" style="color:var(--stock-up)">+1.21%</td><td class="num">26,009.46</td><td class="num">2,572.8亿港元</td></tr>
                <tr><td>恒生科技指数</td><td class="num" style="color:var(--stock-up)">+1.40%</td><td class="num">4,766.16</td><td class="num">—</td></tr>
              </tbody>
            </table>
          </div>
        </div>
        ...
        <div class="ds-card">
          <p class="text-[var(--text-secondary)] text-sm leading-relaxed">
            创业板一枝独秀，北证50独自承压。创业板指大涨<span class="num" style="color:var(--stock-up)">1.43%</span>领涨全场，深证成指（<span class="num" style="color:var(--stock-up)">+0.87%</span>）和沪深300（<span class="num" style="color:var(--stock-up)">+0.57%</span>）紧随其后。中证2000大涨<span class="num" style="color:var(--stock-up)">1.56%</span>，但北证50独跌<span class="num" style="color:var(--stock-down)">0.57%</span>，小微盘内部出现明显分化——小盘（中证2000）强于微盘（北证50）。科创50（<span class="num" style="color:var(--stock-up)">+0.04%</span>）和上证指数（<span class="num" style="color:var(--stock-up)">+0.04%</span>）几乎收平。恒生指数大涨<span class="num" style="color:var(--stock-up)">1.21%</span>，重返26000点，与A股形成共振。
          </p>
        </div>
      `
    },
