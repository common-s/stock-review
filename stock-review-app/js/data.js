 ...
 */
window.DATES = [
  { date: "2026-09-02", subtitle: "全线下挫 · 北证50独涨 · 军工逆势活跃" },
  { date: "2026-08-31", subtitle: "低开高走 · 八月红盘收官 · 传媒板块掀涨停潮" },
  { date: "2026-08-28", subtitle: "冲高回落 · 双创暴跌 · 昨日最强今日最弱" },
  { date: "2026-08-27", subtitle: "科创暴涨 · 半导体爆发 · 量价齐升" },
  { date: "2026-08-26", subtitle: "科创领涨 · 金融有色齐飞 · 权重强于个股" },
...
window.REPORTS = {
  "2026-08-20": {
    ...
    { id: "profit", index: "02", title: "赚钱效应分析", html: `<div class="ds-profit__stack"><div class="ds-profit-rating"><div class="ds-profit-rating__icon-wrap">🌤️</div><div class="ds-profit-rating__body"><div class="ds-profit-rating__title">弱普涨</div><div class="ds-profit-rating__chips"><span class="ds-tag ds-tag--success">偏弱普涨</span><span class="ds-tag ds-tag--success">💡 共振 · 剪刀差 +0.08%</span></div><p class="ds-profit-rating__desc">全市场 <b>4,100</b> 只个股上涨 · <b>1,200</b> 只下跌 · 上涨占比约 <b>75.0%</b> · <span style="color:var(--text-default)">失真：≈ 权重与个股同步，失真度极低</span></p></div><div class="ds-profit-rating__figure"><div class="ds-profit-rating__figure-num" style="color:var(--stock-up)">75.0%</div><div class="ds-profit-rating__figure-label">上涨占比</div></div></div><div class="ds-card"><h3 class="ds-card__title">个股涨跌热力指标</h3><div class="ds-profit-heatgrid"><div class="ds-heat-cell is-up"><div class="ds-heat-cell__head"><i data-lucide="trending-up"></i>上涨个股数</div><div class="ds-heat-cell__val">4,100</div></div><div class="ds-heat-cell is-down"><div class="ds-heat-cell__head"><i data-lucide="trending-down"></i>下跌个股数</div><div class="ds-heat-cell__val">1,200</div></div><div class="ds-heat-cell is-up"><div class="ds-heat-cell__head"><i data-lucide="flame"></i>涨停家数</div><div class="ds-heat-cell__val">—</div></div><div class="ds-heat-cell is-down"><div class="ds-heat-cell__head"><i data-lucide="snowflake"></i>跌停家数</div><div class="ds-heat-cell__val">—</div></div><div class="ds-heat-cell is-up"><div class="ds-heat-cell__head"><i data-lucide="pie-chart"></i>上涨占比</div><div class="ds-heat-cell__val">75.0%</div></div><div class="ds-heat-cell is-up"><div class="ds-heat-cell__head"><i data-lucide="gauge"></i>个股中位数</div><div class="ds-heat-cell__val">+0.17%</div><div class="ds-heat-cell__sub">全市场个股涨跌幅中位数</div></div></div></div><div class="ds-card"><h3 class="ds-card__title">个股 vs 权重（失真度对比）</h3><div class="ds-profit-distortion"><div class="ds-profit-distortion__col"><div class="ds-profit-distortion__vs">个 股</div><div class="ds-statcard"><span class="ds-statcard__label">个股涨跌幅中位数</span><span class="ds-statcard__value" style="color:var(--stock-up)">+0.17%</span></div></div><div class="ds-profit-distortion__scissor"><div class="lbl">指数失真剪刀差</div><div class="big" style="color:var(--stock-up)">+0.08%</div><span class="ds-tag ds-tag--success">共振</span><div class="lbl" style="margin-top:8px;letter-spacing:0.02em;text-transform:none">≈ 权重与个股同步，失真度极低</div></div><div class="ds-profit-distortion__col"><div class="ds-profit-distortion__vs">权 重</div><div class="ds-statcard"><span class="ds-statcard__label">沪深300 加权指数</span><span class="ds-statcard__value" style="color:var(--stock-up)">+0.09%</span></div></div></div></div><div class="ds-card"><h3 class="ds-card__title">持仓 vs 市场（超额收益对比）</h3><div class="ds-profit-holding"><div class="ds-profit-distortion__col"><div class="ds-profit-distortion__vs">持 仓</div><div class="ds-statcard"><span class="ds-statcard__label">持仓收益率</span><span class="ds-statcard__value" style="color:var(--stock-up)">+0.05%</span></div></div><div class="ds-profit-holding__excess"><div class="lbl">超 额 收 益</div><div class="num" style="color:var(--status-warning-default)">-0.12%</div><span class="ds-tag ds-tag--warning">持平市场</span><div class="ds-heat-cell__sub" style="text-align:center">基本持平市场（超额收益接近 0）</div></div><div class="ds-profit-distortion__col"><div class="ds-profit-distortion__vs">市 场</div><div class="ds-statcard"><span class="ds-statcard__label">全市场中位数</span><span class="ds-statcard__value" style="color:var(--stock-up)">+0.17%</span></div></div></div><div class="ds-profit-holding__advice is-flat">💡 超额收益基本持平市场平均，建议关注后续持仓与市场风格的匹配度。</div></div></div>` },
      {
        id: "style",
        index: "03",
        title: "风格强弱排名",
